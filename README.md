...
|기간|프로젝트|설명|역할|기타
|------|------|---|---|------|
|24.08 ~ 24.09|ASK|RAG를 활용한 채용 서비스|EC2 Docker 환경, RAG, JWT 토큰 인증, 백엔드 API 개발|-|
|24.06 ~ 24.07|MilGam|인구 밀집도 감지 및 이상행동 탐지 서비스|GCP서버에 AI 모델 구동 환경, RAG, ERD, 백엔드 API, 프론트 layout 개발|KT AIVLE 최우수|
|23.09 ~ 23.12|Air Map|공항 시설 정보 서비스|프론트 개발|-|
